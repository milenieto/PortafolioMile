      ...
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          <div className="flex-1">
            ...
            <p className= 'text-black '>Si necesitas ayuda respecto una mejor planificación y organización con tus proyectos, contactame</p>
            <div className='mb-4 mt-8'>
                <FaEnvelope className='inline-block text-pink-200 mr-2'></FaEnvelope>
                <a href="mailto: milenanietopirata9@gmail.com" className='hover:underline text-blue'>
                   milenanietopirata9@gmail.com
                </a>
            </div>
            <div className='mb-4'>
                <FaPhone className='inline-block text-pink-200 mr-2'></FaPhone>
                <span className='text-blue'>3534193580</span>
            </div>
            <div className='mb-4'>
                <FaMapMarkedAlt className='inline-block text-pink-200 mr-2'></FaMapMarkedAlt>
                <span className='text-blue'>Dr. Carrilo 1780, Villa Carlos Paz, Argentina </span>
            </div>
          </div>
